  ...
  protected:
    class INET_API DelegatingListener : public cIListener
    {
      ...
      public:
        ...
        virtual void receiveSignal(cComponent *, simsignal_t, OMNETPP5_CODE(long) OMNETPP6_CODE(intval_t) l, cObject *details) { component->emit(signal, l, details); }
        virtual void receiveSignal(cComponent *, simsignal_t, OMNETPP5_CODE(unsigned long) OMNETPP6_CODE(uintval_t) l, cObject *details) { component->emit(signal, l, details); }
